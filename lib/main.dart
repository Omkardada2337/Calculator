    ...
    return MaterialApp(
     title: "CALCULATOR",
      ...
      home: Scaffold(
        ...
        appBar: AppBar(toolbarHeight: 100,shape:RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),backgroundColor: Colors.blueGrey[900],title: Text("Calulator",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 35,color: Colors.grey),),centerTitle: true,),
        body:Padding(
